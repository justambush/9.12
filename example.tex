...
s_{1}(t)=
\begin{cases}
1,\qquad n(t_{1}+10)< t_{1} \leq (n+1)t_{1}+10n,& n=0,1,2,3,......\\
0,\qquad (n+1)t_{1}+10n < t_{1} \leq (n+1)(t_{1}+10),& n=0,1,2,3,......
\end{cases}
\end{equation}
\begin{equation}
Q_{out}(t)=
\begin{cases}
100(t-48.8-100n),& 100n+48.8<t\leq 100n+49\\
20, & 100n+49<t\leq 100n+51\\
100(51.2-t+100n), & 100n+51<t\leq 100n+51.2\\
0, & 100n+51.2<t\leq 100n+148.8
\end{cases}
\end{equation}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=1\textwidth]{mnt.png}
	\caption{1.1模拟图}\label{5}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=1\textwidth]{q1-2.png}
	\caption{1.2(2s)模拟图}\label{6}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=1\textwidth]{q1-3.png}
	\caption{1.2(5s)模拟图}\label{7}
\end{figure}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=1\textwidth]{q1-4.png}
	\caption{1.2(5s)模拟图}\label{8}
\end{figure}
